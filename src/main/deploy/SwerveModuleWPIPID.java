...
public class SwerveModule {
  ...
  private SparkMaxPIDController m_sparkMaxDrivingPIDController;

  
  private final CANSparkMax m_turningMotor;
  private final RelativeEncoder m_sparkMaxTurnEncoder;
  private SparkMaxPIDController m_sparkMaxTurningPIDController;
  ...
  public SwerveModule(
    ...
    m_sparkMaxTurningPIDController = m_turningMotor.getPIDController();
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    double rotations = state.angle.getRadians() * 21.4;
